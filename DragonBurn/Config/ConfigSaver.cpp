...
namespace MyConfigSaver {
    ...
    void SaveConfig(const std::string& filename, const std::string& author) {
        ...
        ConfigData["Name"] = "DragonBurn";
        ConfigData["Version"] = "1.0.1.5";
        ...
        ConfigData["Yaw"]["Enable"]=              RCS::RCSScale.x;
        ConfigData["Pitch"]["Enable"]=            RCS::RCSScale.y;
    ...
    void LoadConfig(const std::string& filename) {
        ...
        if (ConfigData.contains("ESP"))
        {
            ...
            ESPConfig::ShowScoping = ReadData(ConfigData["ESP"]["Scoping"], false);
